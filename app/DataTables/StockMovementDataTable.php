...
class StockMovementDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'sale' => new \Yajra\DataTables\Html\Column(['title' => 'Venta', 'render' => 'function(){return this.sale_relation ? this.sale_relation.customer_relation.name : ""}', 'name' => 'sale_relation.customer_relation.name']),
            'purchase' => new \Yajra\DataTables\Html\Column(['title' => 'Compra', 'render' => 'function(){return this.purchase_relation ? this.purchase_relation.supplier_relation.name : ""}', 'name' => 'purchase_relation.supplier_relation.name']),
            'process' => new \Yajra\DataTables\Html\Column(['title' => 'Proceso', 'render' => 'function(){return this.process_relation ? this.process_relation.responsible_relation.name : ""}', 'name' => 'process_relation.responsible_relation.name']),
            'user' => new \Yajra\DataTables\Html\Column(['title' => 'Usuario', 'render' => 'function(){
                ...
                }', 'name' => 'process_relation.user_relation.name']),
