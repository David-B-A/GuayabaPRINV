...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('customer',[null => 'Seleccionar'] + $customers, null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('status', ['Pedido' => 'Pedido', 'En transporte' => 'En transporte', 'Entregado' => 'Entregado', 'Devolucion' => 'Devolucion'], null, ['class' => 'form-control custom-select']) !!}
</div>
...
<table class="table">
    ...
    <!-- 
        * To avoid notation mixing, the products in the sale will be called items, 
